...
class AmplitudeMaskTab(QWidget):
    ...
    def loadAmplitudeFromFile(self):
        ...
        name = QFileDialog.getOpenFileName(self,"Open File","${HOME}","Image files (*.bmp *.png);;",)
        ...
        if not outcome:
            ...
            dlg.setText("There was an error loading the amplitude mask file, check the file and try again")
            button = dlg.exec()
