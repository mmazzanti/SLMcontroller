...
class RenderingThread(QThread):
    ...
    def save_picture(self):
        ...
        img_name = "Img/frame_{}.png".format(timestamp)
...
class CameraWindow(QMainWindow):
    def __init__(self):
        ...
        self.pos_sliderX.setTickInterval(1)
        ...
        self.pos_sliderY.setTickInterval(1)
        ...
        self.pos_slider_r.setTickInterval(1)
